...
def _proc_function(data_list, process, save_callback, out_path, save_batch, ith_process, shared_data = None):
...
def mp_lock(data_list, process, save_callback, num_procs, out_path, shared_data = None, save_batch=10):
    ...
    with tqdm(total=len(data_list)) as pbar:
        args = [(data, process, save_callback, out_path, save_batch, i, shared_data) for i,data in enumerate(data_split)]
